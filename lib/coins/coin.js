...
function Coin(data){
  ...
  this.coinDevAddress = "COIN_DEV_ADDRESS";  // coin developer address
  this.poolDevAddress = "POOL_DEV_ADDRESS";  // bomb-on's (or pool dev) address
  ...
  this.prefix = CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX;

  this.supportsAutoExchange = false;

  this.niceHashDiff = 400000;  // adjust for your needs
...
//        return cnUtil.address_decode_integrated(address) === this.intPrefix;
  ...
  this.cryptoNight = function(convertedBlob) {
    // use appropriate `multiHashing` function, depending on coin
